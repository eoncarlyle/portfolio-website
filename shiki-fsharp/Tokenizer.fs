...
let tokenizeWithTheme (code: string) (grammar: IGrammar) (colorMap: string array) : ThemedToken[][] =
    ...
    for i = 0 to lines.Length - 1 do
        ...
        if line = "" then
            ...
            let lineResult =
                grammar.TokenizeLine2(LineText(line), stateStack, TimeSpan.FromMilliseconds(500.0))
